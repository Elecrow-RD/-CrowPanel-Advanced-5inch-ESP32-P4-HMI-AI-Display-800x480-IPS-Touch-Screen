...
#include "../common/ppa/lcd_ppa.h"
    ...
    (CONFIG_IDF_TARGET_ESP32P4 && ESP_IDF_VERSION >= ESP_IDF_VERSION_VAL(5, 3, 0))
...
#else
        ESP_RETURN_ON_FALSE(false, NULL, TAG, "RGB is supported only on ESP32S3 (from IDF 5.0) and ESP32-P4 (from IDF 5.3)!");
#endif
