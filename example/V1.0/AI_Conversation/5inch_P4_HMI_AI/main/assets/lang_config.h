/*---------------------------------------------------------------
 * Teaching module overview: Embedded language assets
 * This generated mapping selects the primary locale and fallback
 * resources used when the requested translation is unavailable.
 *--------------------------------------------------------------*/
...
namespace Lang {
    ...
    namespace Strings {
        constexpr const char* ACCESS_VIA_BROWSER = ", access via browser ";
        constexpr const char* ACTIVATION = "Activate device";
        ...
        constexpr const char* BATTERY_NEED_CHARGE = "Battery low, please charge";
        constexpr const char* CHECKING_NEW_VERSION = "Checking for new version...";
        constexpr const char* CHECK_NEW_VERSION_FAILED = "Failed to check new version, retrying in %d seconds: %s";
        ...
        constexpr const char* CONNECT_TO = "Connecting to ";
        constexpr const char* CONNECT_TO_HOTSPOT = "Connect phone to hotspot ";
        ...
        constexpr const char* FOUND_NEW_ASSETS = "New assets found: %s";
        ...
        constexpr const char* LOADING_PROTOCOL = "Logging in to server...";
        constexpr const char* MAX_VOLUME = "Maximum volume";
        ...
        constexpr const char* SERVER_ERROR = "Send failed, please check network";
        constexpr const char* SERVER_NOT_CONNECTED = "Unable to connect to service, please try again later";
        constexpr const char* SERVER_NOT_FOUND = "Searching for available services";
        constexpr const char* SERVER_TIMEOUT = "Response timeout";
        ...
        constexpr const char* UPGRADING = "Upgrading system...";
