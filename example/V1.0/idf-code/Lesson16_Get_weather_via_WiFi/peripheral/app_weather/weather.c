...
/**
 * @brief Perform the weather create operation.
 *
...
/**
 * @brief Perform the weather destroy operation.
 *
 * Called by the application when this module operation is required.
 * @param weather Input or output value used by this operation.
 * @return None.
 */
...
/**
 * @brief Perform the weather get weather operation.
 *
 * Called by the application when this module operation is required.
 * @param weather Input or output value used by this operation.
 * @param temp_c Input or output value used by this operation.
 * @param weather_text Input or output value used by this operation.
 * @param timestamp Input or output value used by this operation.
 * @return Result produced by the operation; see the function implementation for success and error values.
 */
