...
/**
 * @brief Perform the bsp wifi connect operation.
 *
 * Called by the application when this module operation is required.
 * @param ssid Input or output value used by this operation.
...
/**
 * @brief Perform the bsp wifi disconnect operation.
 *
 * Called by the application when this module operation is required.
 * @return None.
 */
...
/**
 * @brief Perform the bsp wifi init operation.
 *
...
/**
 * @brief Perform the bsp wifi sta init operation.
 *
 * Called during application startup before the related peripheral is used.
 * @return None.
 */
...
/**
 * @brief Perform the bsp wifi ap init operation.
 *
 * Called during application startup before the related peripheral is used.
 * @return None.
 */
...
/**
 * @brief Perform the bsp wifi get state operation.
 *
 * Called by the application when this module operation is required.
...
/**
 * @brief Perform the bsp wifi ap sta deinit operation.
 *
 * Called during application startup before the related peripheral is used.
 * @return None.
 */
