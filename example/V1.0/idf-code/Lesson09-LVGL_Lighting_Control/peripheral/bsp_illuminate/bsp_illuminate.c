...
/* brightness -  (0 - 100) */
/**
 * @brief Perform the set lcd blight operation.
 *
 * Called by the application when this module operation is required.
 * @param brightness Input or output value used by this operation.
...
/**
 * @brief Perform the display port init operation.
 *
...
/**
 * @brief Perform the lvgl init operation.
 *
 * Called during application startup before the related peripheral is used.
 * @return Result produced by the operation; see the function implementation for success and error values.
 */
...
/**
 * @brief Perform the fill screen with color operation.
 *
 * Called by the application when this module operation is required.
...
/**
 * @brief Perform the display init operation.
 *
 * Called during application startup before the related peripheral is used.
 * @return Result produced by the operation; see the function implementation for success and error values.
 */
