...
#if CONFIG_SOC_LCD_RGB_SUPPORTED && ESP_IDF_VERSION >= ESP_IDF_VERSION_VAL(5, 0, 0)
...
#else
        ESP_RETURN_ON_FALSE(false, NULL, TAG, "RGB LCD is not supported by this target or ESP-IDF version");
#endif
