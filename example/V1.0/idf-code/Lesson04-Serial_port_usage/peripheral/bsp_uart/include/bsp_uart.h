/**
 * @file bsp_uart.h
 * @brief Teaching source for 5inch_P4_IDF_04_Serial_Port_Usage.
 *
...
#define UART_IN_EXTRA_GPIO_TXD 27    // Define GPIO number 34 as UART TXD pin for input extra UART
#define UART_IN_EXTRA_GPIO_RXD 28    // Define GPIO number 33 as UART RXD pin for input extra UART
