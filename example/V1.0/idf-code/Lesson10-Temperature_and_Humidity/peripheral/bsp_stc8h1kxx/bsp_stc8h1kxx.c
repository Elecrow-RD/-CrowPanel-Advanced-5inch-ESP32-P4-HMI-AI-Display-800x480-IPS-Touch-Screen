...
/**
 * @brief Perform the stc8 i2c init operation.
 *
...
/**
 * @brief Perform the stc8 battery info get operation.
 *
 * Called by the application when this module operation is required.
 * @param bat_info Input or output value used by this operation.
 * @return Result produced by the operation; see the function implementation for success and error values.
 */
...
/**
 * @brief Perform the stc8 gpio get level operation.
 *
 * Called by the application when this module operation is required.
 * @param gpio_num Input or output value used by this operation.
 * @param level Input or output value used by this operation.
 * @return Result produced by the operation; see the function implementation for success and error values.
 */
...
/**
 * @brief Perform the stc8 gpio set level operation.
 *
 * Called by the application when this module operation is required.
 * @param gpio_num Input or output value used by this operation.
 * @param level Input or output value used by this operation.
...
/**
 * @brief Perform the stc8 set pwm duty operation.
 *
 * Called by the application when this module operation is required.
 * @param pwm_num Input or output value used by this operation.
 * @param duty Input or output value used by this operation.
 * @return Result produced by the operation; see the function implementation for success and error values.
 */
