...
/**
 * @brief Perform the set sx1262 tx flag operation.
 *
...
/**
 * @brief Perform the set sx1262 rx flag operation.
 *
 * Called by the application when this module operation is required.
 * @return None.
 */
...
esp_err_t BSP_NRF2401::NRF24_tx_init()
{
  ...
  nrf_hal.setSpiFrequency(2000000);
  nrf_hal.spiBegin();
...
/**
 * @brief Perform the set rx flag operation.
 *
 * Called by the application when this module operation is required.
 * @return None.
 */
