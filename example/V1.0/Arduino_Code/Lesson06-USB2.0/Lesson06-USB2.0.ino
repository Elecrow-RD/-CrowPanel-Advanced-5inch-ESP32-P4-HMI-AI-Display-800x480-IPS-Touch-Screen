...
E (91214) sdmmc_common: sdmmc_init_ocr: send_op_cond (1) returned 0x107
E (91215) vfs_fat_sdmmc: sdmmc_card_init failed (0x107).
[INFO] Failed to initialize the card (ESP_ERR_TIMEOUT). Make sure SD card lines have pull-up resistors in place.
[ERROR] SD card initialization failed [ ESP_ERR_TIMEOUT ]
[INFO] Mounting filesystem
E (92262) sdmmc_common: sdmmc_init_ocr: send_op_cond (1) returned 0x107
E (92263) vfs_fat_sdmmc: sdmmc_card_init failed (0x107).
[INFO] Failed to initialize the card (ESP_ERR_TIMEOUT). Make sure SD card lines have pull-up resistors in place.
[ERROR] SD card initialization failed [ ESP_ERR_TIMEOUT ]
[INFO] Mounting filesystem
E (93310) sdmmc_common: sdmmc_init_ocr: send_op_cond (1) returned 0x107
E (93311) vfs_fat_sdmmc: sdmmc_card_init failed (0x107).
[INFO] Failed to initialize the card (ESP_ERR_TIMEOUT). Make sure SD card lines have pull-up resistors in place.
[ERROR] SD card initialization failed [ ESP_ERR_TIMEOUT ]
