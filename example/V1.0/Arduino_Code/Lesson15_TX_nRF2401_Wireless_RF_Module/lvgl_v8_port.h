...
#define LVGL_PORT_BUFFER_MALLOC_CAPS            (MALLOC_CAP_SPIRAM | MALLOC_CAP_DMA | MALLOC_CAP_8BIT)      // Allocate LVGL buffer in PSRAM
...
#define LVGL_PORT_TASK_PRIORITY                 (15)         // The priority of the LVGL timer task
