 ...
 * @brief Connects the display hardware to LVGL and configures the graphics runtime.
 *
 * This file belongs to the Lesson15_TX_nRF2401_Wireless_RF_Module course project. Comments explain the
...
/**
 * @brief Read get next frame buffer without changing the requested application state.
 *
 * Called whenever the application needs the latest value.
 *
 * @param lcd Value supplied by the caller for this operation.
 *
...
/**
 * @brief Perform the copy pixel 8bpp operation used by this lesson.
 *
 * Called from the application flow when this operation is required.
 *
 * @param to Value supplied by the caller for this operation.
 *
 * @param from Value supplied by the caller for this operation.
 *
 * @return Nothing.
 */
...
/**
 * @brief Perform the copy pixel 16bpp operation used by this lesson.
 *
 * Called from the application flow when this operation is required.
 *
 * @param to Value supplied by the caller for this operation.
...
/**
 * @brief Perform the copy pixel 24bpp operation used by this lesson.
 *
 * Called from the application flow when this operation is required.
 *
 * @param to Value supplied by the caller for this operation.
...
/**
 * @brief Perform the rotate copy pixel operation used by this lesson.
 *
 * Called from the application flow when this operation is required.
 *
 * @param from Value supplied by the caller for this operation.
 ...
 * @param to Value supplied by the caller for this operation.
 *
 * @param x_start Value supplied by the caller for this operation.
 *
 * @param y_start Value supplied by the caller for this operation.
 *
 * @param x_end Value supplied by the caller for this operation.
 *
 * @param y_end Value supplied by the caller for this operation.
 *
 * @param w Value supplied by the caller for this operation.
 *
 * @param h Value supplied by the caller for this operation.
 *
 * @param rotate Value supplied by the caller for this operation.
 *
 * @return Nothing.
 */
__attribute__((always_inline))
...
/**
 * @brief Perform the flush dirty save operation used by this lesson.
 *
 * Called from the application flow when this operation is required.
 *
 * @param dirty_area Value supplied by the caller for this operation.
 *
 * @return Nothing.
 */
 ...
 */
/**
 * @brief Perform the flush copy probe operation used by this lesson.
 *
 * Called from the application flow when this operation is required.
 *
 * @param drv Value supplied by the caller for this operation.
 *
 * @return Result produced by the operation; see the function body for its exact meaning.
 */
...
/**
 * @brief Perform the flush get next buf operation used by this lesson.
 *
 * Called from the application flow when this operation is required.
 *
 * @param lcd Value supplied by the caller for this operation.
 ...
 * Called from the application flow when this operation is required.
 *
 * @param dst Value supplied by the caller for this operation.
 *
 * @param src Value supplied by the caller for this operation.
 *
 * @param dirty_area Value supplied by the caller for this operation.
 *
 * @return Nothing.
...
/**
 * @brief Handle the flush callback event and pass the result to the application.
 *
 * Called by the owning driver or framework when the event occurs.
 *
 * @param drv Value supplied by the caller for this operation.
 *
 * @param area Value supplied by the caller for this operation.
 *
 * @param color_map Value supplied by the caller for this operation.
 *
 * @return Nothing.
 */
...
/**
 * @brief Handle the on LCD vsync callback event and pass the result to the application.
 *
 * Called by the owning driver or framework when the event occurs.
 *
 * @param user_data Value supplied by the caller for this operation.
 *
 * @return Result produced by the operation; see the function body for its exact meaning.
 */
...
/**
 * @brief Handle the update callback event and pass the result to the application.
 *
 * Called by the owning driver or framework when the event occurs.
 *
 * @param drv Value supplied by the caller for this operation.
...
/**
 * @brief Handle the rounder callback event and pass the result to the application.
 *
 * Called by the owning driver or framework when the event occurs.
 *
 * @param drv Value supplied by the caller for this operation.
...
/**
 * @brief Initialize display init and leave it ready for later operations.
 *
...
/**
 * @brief Perform the touchpad read operation used by this lesson.
 *
 * Called from the application flow when this operation is required.
 *
 * @param indev_drv Value supplied by the caller for this operation.
 *
...
/**
 * @brief Handle the on touch interrupt callback event and pass the result to the application.
 *
 * Called by the owning driver or framework when the event occurs.
 *
 * @param user_data Value supplied by the caller for this operation.
...
/**
 * @brief Initialize indev init and leave it ready for later operations.
 *
 * Called during application startup before the feature is used.
 *
 * @param tp Value supplied by the caller for this operation.
 *
 * @return Result produced by the operation; see the function body for its exact meaning.
 */
...
#if !LV_TICK_CUSTOM
/**
 * @brief Perform the tick increment operation used by this lesson.
 *
 * Called from the application flow when this operation is required.
 *
 * @param arg Value supplied by the caller for this operation.
 *
 * @return Nothing.
 */
...
/**
 * @brief Initialize tick init and leave it ready for later operations.
 *
 * Called during application startup before the feature is used.
 *
 * @return Result produced by the operation; see the function body for its exact meaning.
...
/**
 * @brief Initialize tick deinit and leave it ready for later operations.
 *
 * Called during application startup before the feature is used.
 *
 * @return Result produced by the operation; see the function body for its exact meaning.
...
/**
 * @brief Run the LVGL port task worker independently from the Arduino main loop.
 *
...
/**
 * @brief Handle the on draw bitmap finish callback event and pass the result to the application.
 *
 * Called by the owning driver or framework when the event occurs.
 *
 * @param user_data Value supplied by the caller for this operation.
...
/**
 * @brief Initialize LVGL port init and leave it ready for later operations.
 *
 * Called during application startup before the feature is used.
 *
 * @param lcd Value supplied by the caller for this operation.
...
/**
 * @brief Perform the LVGL port lock operation used by this lesson.
 *
 * Called from the application flow when this operation is required.
 *
 * @param timeout_ms Value supplied by the caller for this operation.
 *
 * @return Result produced by the operation; see the function body for its exact meaning.
 */
...
/**
 * @brief Perform the LVGL port unlock operation used by this lesson.
 *
 * Called from the application flow when this operation is required.
 *
 * @return Result produced by the operation; see the function body for its exact meaning.
...
/**
 * @brief Initialize LVGL port deinit and leave it ready for later operations.
 *
 * Called during application startup before the feature is used.
 *
 * @return Result produced by the operation; see the function body for its exact meaning.
