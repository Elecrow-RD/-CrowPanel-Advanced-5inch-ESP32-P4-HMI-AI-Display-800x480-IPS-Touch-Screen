...
/*---------------------------------------------------------------
 * Lesson09-Lvgl Lighting Control Module
...
/**
 * @brief Perform the btn on click event operation used by this lesson.
 *
 * Called from the application flow when this operation is required.
 *
 * @param e Value supplied by the caller for this operation.
 *
 * @return Nothing.
 */
...
/**
 * @brief Perform the btn off click event operation used by this lesson.
 *
 * Called from the application flow when this operation is required.
 *
 * @param e Value supplied by the caller for this operation.
...
/**
 * @brief Create and initialize the resources used by create led control ui.
 *
