/**
 * @file weather.c
 * @brief Provides HTTP weather retrieval and JSON parsing for the Wi-Fi weather lesson.
 *
...
/**
 * @brief Create and initialize the resources used by weather create.
 *
...
/**
 * @brief Release the resources owned by weather destroy.
 *
 * Called when the corresponding feature is no longer needed.
 *
 * @param weather Value supplied by the caller for this operation.
 *
 * @return Nothing.
 */
...
/**
 * @brief Perform the weather get weather operation used by this lesson.
 *
 * Called from the application flow when this operation is required.
 *
 * @param weather Value supplied by the caller for this operation.
 *
 * @param temp_c Value supplied by the caller for this operation.
 *
 * @param weather_text Value supplied by the caller for this operation.
 *
 * @param timestamp Value supplied by the caller for this operation.
 *
 * @return Result produced by the operation; see the function body for its exact meaning.
 */
