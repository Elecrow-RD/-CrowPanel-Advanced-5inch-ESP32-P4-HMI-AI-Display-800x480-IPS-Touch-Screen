...
void weather_display()
{
    ...
    if (lvgl_port_lock(-1)) {
        ...
        lv_obj_remove_flag(ui_home, (lv_obj_flag_t)(LV_OBJ_FLAG_SCROLLABLE | LV_OBJ_FLAG_SCROLL_ELASTIC | LV_OBJ_FLAG_SCROLL_MOMENTUM));
        lv_obj_set_style_bg_opa(ui_home, LV_OPA_COVER, LV_PART_MAIN);
        lv_obj_set_style_radius(ui_home, 0, LV_PART_MAIN);
