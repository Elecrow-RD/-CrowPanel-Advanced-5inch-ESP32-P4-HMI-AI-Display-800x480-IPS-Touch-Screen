/**
 * @file Lesson14_RX_SX1262_Wireless_Module.ino
...
/*---------------------------------------------------------------
 * Lesson14 Receive Sx1262 Wireless Module Module
 ...
 *
 * @param rssi Value supplied by the caller for this operation.
 *
 * @param snr Value supplied by the caller for this operation.
 *
 * @return Nothing.
 */
...
static void lvgl_show_rx_interface_init(void)
{
    ...
    lv_obj_t *screen = lv_screen_active();  // Get the current active LVGL screen object
