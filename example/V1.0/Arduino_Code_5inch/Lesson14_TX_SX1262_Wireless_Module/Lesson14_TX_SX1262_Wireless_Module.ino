/**
 * @file Lesson14_TX_SX1262_Wireless_Module.ino
...
/*---------------------------------------------------------------
 * Lesson14 Transmit Sx1262 Wireless Module Module
...
#error "Lesson14 requires PSRAM. In Arduino IDE select Tools > PSRAM > Enabled."
#endif
...
/**
 * @brief Run the lora transmit task worker independently from the Arduino main loop.
 *
 * Called by the FreeRTOS scheduler after the task is created.
 *
 * @param param Value supplied by the caller for this operation.
