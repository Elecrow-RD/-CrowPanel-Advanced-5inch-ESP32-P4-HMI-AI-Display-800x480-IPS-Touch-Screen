 ...
 *
 * This file belongs to the Lesson04-Serial_port_usage course project. Comments explain the
 * teaching flow without changing the original program behavior.
 */

/*---------------------------------------------------------------
 * Lesson04-Serial Port Usage Module
...
#define WIFI_SSID "yanfa1"  // WiFi network name
#define WIFI_PASS "1223334444yanfa"  // WiFi network password
...
————————————————————————————————————————————————————————————————————————— */
/**
 * @brief Initialize UART init and leave it ready for later operations.
 *
...
/**
 * @brief Apply the requested send data operation to the associated device or service.
 *
...
/**
 * @brief Perform the UART read response operation used by this lesson.
 *
 * Called from the application flow when this operation is required.
 *
 * @param buffer Value supplied by the caller for this operation.
 *
 * @param len Value supplied by the caller for this operation.
 *
 * @param timeout Value supplied by the caller for this operation.
 *
 * @return Result produced by the operation; see the function body for its exact meaning.
 */
...
/**
 * @brief Apply the requested send at command operation to the associated device or service.
 *
 * Called when the application needs to update that feature.
 *
 * @param cmd Value supplied by the caller for this operation.
 *
 * @param timeout Value supplied by the caller for this operation.
 *
 * @return Result produced by the operation; see the function body for its exact meaning.
...
/**
 * @brief Perform the connect Wi-Fi operation used by this lesson.
 *
 * Called from the application flow when this operation is required.
 *
 * @return Result produced by the operation; see the function body for its exact meaning.
...
/**
 * @brief Run the Wi-Fi task worker independently from the Arduino main loop.
 *
