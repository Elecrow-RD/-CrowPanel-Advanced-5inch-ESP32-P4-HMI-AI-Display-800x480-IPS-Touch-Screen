...
/*---------------------------------------------------------------
 * Lesson11-Playback After Recording Module
...
/**
 * @brief Perform the recording operation used by this lesson.
 *
...
void loop() {
    ...
    /* Uncomment this code and comment 'recording()' to play the "hello" audio */
    // stc8_gpio_set_level(STC8_GPIO_OUT_AUDIO_SD, AUDIO_POWER_ENABLE);
    // i2s_spk.write(Audio, sizeof(Audio));
    // stc8_gpio_set_level(STC8_GPIO_OUT_AUDIO_SD, AUDIO_POWER_DISABLE);
    // delay(1000);
