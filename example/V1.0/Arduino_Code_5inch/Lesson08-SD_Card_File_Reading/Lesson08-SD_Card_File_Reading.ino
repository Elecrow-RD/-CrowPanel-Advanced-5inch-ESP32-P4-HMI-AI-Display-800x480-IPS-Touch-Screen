...
/*---------------------------------------------------------------
 * Lesson08-Sd Card File Reading Module
...
/**
 * @brief Create and initialize the resources used by create file.
 *
 * Called before the corresponding feature is accessed.
 *
 * @param filename Value supplied by the caller for this operation.
 *
...
/**
 * @brief Apply the requested write string file operation to the associated device or service.
 *
 ...
 * @return Result produced by the operation; see the function body for its exact meaning.
 */
esp_err_t write_string_file(const char *filename, const char *data)
{
...
/**
 * @brief Read read string file without changing the requested application state.
 *
...
/**
 * @brief Apply the requested write file operation to the associated device or service.
 *
 * Called when the application needs to update that feature.
 *
 * @param filename Value supplied by the caller for this operation.
 ...
 * @param data Value supplied by the caller for this operation.
 *
 * @param size Value supplied by the caller for this operation.
 *
 * @return Result produced by the operation; see the function body for its exact meaning.
 */
...
/**
 * @brief Apply the requested write file seek operation to the associated device or service.
 *
 * Called when the application needs to update that feature.
 *
 * @param filename Value supplied by the caller for this operation.
 ...
 * @param size Value supplied by the caller for this operation.
 *
 * @param seek Value supplied by the caller for this operation.
 *
 * @return Result produced by the operation; see the function body for its exact meaning.
 */
...
/**
 * @brief Read read file without changing the requested application state.
 *
 * Called whenever the application needs the latest value.
 *
 * @param filename Value supplied by the caller for this operation.
...
/**
 * @brief Read read file size without changing the requested application state.
 *
 * Called whenever the application needs the latest value.
 *
 * @param read_filename Value supplied by the caller for this operation.
 *
 * @return Result produced by the operation; see the function body for its exact meaning.
 */
...
/**
 * @brief Read read write file without changing the requested application state.
 *
 * Called whenever the application needs the latest value.
 *
 * @param read_filename Value supplied by the caller for this operation.
 *
 * @param write_filename Value supplied by the caller for this operation.
 *
 * @return Result produced by the operation; see the function body for its exact meaning.
 */
...
/**
 * @brief Initialize SD init and leave it ready for later operations.
 *
...
/**
 * @brief Read get SD card info without changing the requested application state.
 *
 * Called whenever the application needs the latest value.
 *
 * @return Nothing.
...
/**
 * @brief Perform the format SD card operation used by this lesson.
 *
...
/**
 * @brief Run the SD task worker independently from the Arduino main loop.
 *
...
void sd_task(void *param)   // SD card test task function
{
    ...
    const char *data = "hello world!";   // Data to be written into the file
...
/**
 * @brief Initialize init and leave it ready for later operations.
 *
 * Called during application startup before the feature is used.
 *
 * @return Nothing.
