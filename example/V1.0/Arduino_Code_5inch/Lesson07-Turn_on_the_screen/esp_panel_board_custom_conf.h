/*---------------------------------------------------------------
 * Esp Panel Board Custom Conf Module
 ...
 */
    ...
    #define ESP_PANEL_BOARD_LCD_RGB_CLK_HZ          (LCD_CLK_MHZ * 1000 * 1000)
    ...
    #define ESP_PANEL_BOARD_LCD_RGB_HPW             (LCD_HPW)
    #define ESP_PANEL_BOARD_LCD_RGB_HBP             (LCD_HBP)
    #define ESP_PANEL_BOARD_LCD_RGB_HFP             (LCD_HFP)
    #define ESP_PANEL_BOARD_LCD_RGB_VPW             (LCD_VPW)
    #define ESP_PANEL_BOARD_LCD_RGB_VBP             (LCD_VBP)
    #define ESP_PANEL_BOARD_LCD_RGB_VFP             (LCD_VFP)
    ...
    #define ESP_PANEL_BOARD_LCD_RGB_IO_HSYNC        (RGB_PIN_NUM_HSYNC  )                    
    #define ESP_PANEL_BOARD_LCD_RGB_IO_VSYNC        (RGB_PIN_NUM_VSYNC  )                 
    #define ESP_PANEL_BOARD_LCD_RGB_IO_DE           (RGB_PIN_NUM_DE     )   // -1 if not used
    #define ESP_PANEL_BOARD_LCD_RGB_IO_PCLK         (RGB_PIN_NUM_PCLK   )                 
    #define ESP_PANEL_BOARD_LCD_RGB_IO_DISP         (RGB_PIN_NUM_DISP_EN)   // -1 if not used. Typically set to -1
                                                                            ...
                                                                            // ┗------|--------------|--------|--------|--------|
    #define ESP_PANEL_BOARD_LCD_RGB_IO_DATA0        (RGB_PIN_NUM_DATA0 )    //        |      D0      |   B0   |  B0-1  |   B0-3 |
    #define ESP_PANEL_BOARD_LCD_RGB_IO_DATA1        (RGB_PIN_NUM_DATA1 )    //        |      D1      |   B1   |  B2    |   B4   |
    #define ESP_PANEL_BOARD_LCD_RGB_IO_DATA2        (RGB_PIN_NUM_DATA2 )    //        |      D2      |   B2   |  B3    |   B5   |
    #define ESP_PANEL_BOARD_LCD_RGB_IO_DATA3        (RGB_PIN_NUM_DATA3 )    //        |      D3      |   B3   |  B4    |   B6   |
    #define ESP_PANEL_BOARD_LCD_RGB_IO_DATA4        (RGB_PIN_NUM_DATA4 )    //        |      D4      |   B4   |  B5    |   B7   |
    #define ESP_PANEL_BOARD_LCD_RGB_IO_DATA5        (RGB_PIN_NUM_DATA5 )    //        |      D5      |   G0   |  G0    |   G0-2 |
    #define ESP_PANEL_BOARD_LCD_RGB_IO_DATA6        (RGB_PIN_NUM_DATA6 )    //        |      D6      |   G1   |  G1    |   G3   |
    #define ESP_PANEL_BOARD_LCD_RGB_IO_DATA7        (RGB_PIN_NUM_DATA7 )    //        |      D7      |   G2   |  G2    |   G4   |
#if ESP_PANEL_BOARD_LCD_RGB_DATA_WIDTH > 8                                  //        ┗--------------┫--------|--------|--------|
    #define ESP_PANEL_BOARD_LCD_RGB_IO_DATA8        (RGB_PIN_NUM_DATA8 )    //                       |   G3   |  G3    |   G5   |
    #define ESP_PANEL_BOARD_LCD_RGB_IO_DATA9        (RGB_PIN_NUM_DATA9 )    //                       |   G4   |  G4    |   G6   |
    #define ESP_PANEL_BOARD_LCD_RGB_IO_DATA10       (RGB_PIN_NUM_DATA10)    //                       |   G5   |  G5    |   G7   |
    #define ESP_PANEL_BOARD_LCD_RGB_IO_DATA11       (RGB_PIN_NUM_DATA11)    //                       |   R0   |  R0-1  |   R0-3 |
    #define ESP_PANEL_BOARD_LCD_RGB_IO_DATA12       (RGB_PIN_NUM_DATA12)    //                       |   R1   |  R2    |   R4   |
    #define ESP_PANEL_BOARD_LCD_RGB_IO_DATA13       (RGB_PIN_NUM_DATA13)    //                       |   R2   |  R3    |   R5   |
    #define ESP_PANEL_BOARD_LCD_RGB_IO_DATA14       (RGB_PIN_NUM_DATA14)    //                       |   R3   |  R4    |   R6   |
    #define ESP_PANEL_BOARD_LCD_RGB_IO_DATA15       (RGB_PIN_NUM_DATA15)    //                       |   R4   |  R5    |   R7   |
                                                                            //                       ┗--------┻--------┻--------┛
 ...
 * ensure that the host is initialized only once.
 */
#define ESP_PANEL_BOARD_TOUCH_BUS_SKIP_INIT_HOST        (0)     // Let ESP32_Display_Panel initialize the shared I2C host
#endif
 ...
 */
#define ESP_PANEL_BOARD_TOUCH_RST_IO            (Touch_GPIO_RST)    // Reset pin, -1 if not used
#define ESP_PANEL_BOARD_TOUCH_RST_LEVEL         (0)     // Reset active level, 0: low, 1: high
#define ESP_PANEL_BOARD_TOUCH_INT_IO            (Touch_GPIO_INT)    // Interrupt pin, -1 if not used
